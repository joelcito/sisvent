    ...
    <tbody class="text-gray-600 fw-semibold">
        @forelse ( $clientes as  $cli )
            <tr>
                ...
                <td>
                    <button class="btn btn-icon btn-sm btn-warning" onclick="editarCliente('{{$cli->id}}', '{{$cli->nombres}}', '{{$cli->ap_paterno}}', '{{$cli->ap_materno}}', '{{$cli->cedula}}', '{{$cli->celular}}', '{{$cli->correo}}')"><i class="fa fa-edit"></i></button>
